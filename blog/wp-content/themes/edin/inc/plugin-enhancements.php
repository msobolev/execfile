...
add_action( 'admin_enqueue_scripts', 'edin_enqueue_scripts' );
 ...
 */
function edin_dismiss_admin_notice() {
...
add_action( 'wp_ajax_edin_jetpack_admin_notice', 'edin_dismiss_admin_notice' );
