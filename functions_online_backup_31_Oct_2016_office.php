...
function add_user($name,$email,$password,$status,$last_name = '',$form_type = '',$text_only = '')
{
    //com_db_query("INSERT into ".TABLE_USER."(first_name,email,status,add_date) values('".$name."','".$email."','".$status."','".date("Y-m-d:H:i:s")."')");	
    com_db_query("INSERT into ".TABLE_USER."(first_name,email,password,status,last_name,form_type,add_date,text_only) values('".$name."','".$email."','".$password."','".$status."','".$last_name."','".$form_type."','".date("Y-m-d:H:i:s")."','".$text_only."')");	    
} 
