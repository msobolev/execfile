...
//echo "<pre>all_data DL: ";   print_r($all_data);   echo "</pre>";  die();
...
for($v=0;$v<=$all_data_count;$v++)
{
    ...
    elseif($all_data[$v]['type'] == 'movement')
    {
        ...
        $movement_array[$movement_count]['industry_title'] = $all_data[$v]['industry_title'];
    ...
    elseif($all_data[$v]['type'] == 'jobs')
    {
        ...
        $jobs_array[$jobs_count]['state_short'] = $all_data[$v]['state_short'];
...
//echo "<pre>speaking_array: ";   print_r($speaking_array);   echo "</pre>"; die();
...
{    
    ...
    $xls->Text($xlsRow,17,"Event Date");
    $xls->Text($xlsRow,18,"Role");
    $xls->Text($xlsRow,19,"Topic");
    $xls->Text($xlsRow,20,"Event");
    $xls->Text($xlsRow,21,"Link");
    $xlsRow++;
    for($sp=0;$sp<=$speaking_count;$sp++)
    {
        $xls->Text($xlsRow,1,$speaking_array[$sp]['first_name']);
        $xls->Text($xlsRow,2,$speaking_array[$sp]['last_name']);
        $xls->Text($xlsRow,3,$speaking_array[$sp]['title']);
        $xls->Text($xlsRow,4,$speaking_array[$sp]['email']);
        $xls->Text($xlsRow,5,$speaking_array[$sp]['phone']);
        $xls->Text($xlsRow,6,$speaking_array[$sp]['company_name']);
        $xls->Text($xlsRow,7,$speaking_array[$sp]['company_website']);
        $xls->Text($xlsRow,8,$speaking_array[$sp]['company_revenue']);
        $xls->Text($xlsRow,9,$speaking_array[$sp]['company_employee']);
        $xls->Text($xlsRow,10,$speaking_array[$sp]['industry_title']);
        $xls->Text($xlsRow,11,$speaking_array[$sp]['address']);
        $xls->Text($xlsRow,12,$speaking_array[$sp]['address2']);
        $xls->Text($xlsRow,13,$speaking_array[$sp]['city']);
        $xls->Text($xlsRow,14,$speaking_array[$sp]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$speaking_array[$sp]['zip_code']);
        $xls->Text($xlsRow,17,$speaking_array[$sp]['event_date']);
        $xls->Text($xlsRow,18,$speaking_array[$sp]['role']);
        $xls->Text($xlsRow,19,$speaking_array[$sp]['topic']);
        $xls->Text($xlsRow,20,$speaking_array[$sp]['event']);
        $xls->Text($xlsRow,21,$speaking_array[$sp]['speaking_link']);
...
if($awards_count > 0)
{
    ...
    $xls->Text($xlsRow,17,"Awards Date");
    $xls->Text($xlsRow,18,"Awards Title");
    $xls->Text($xlsRow,19,"Award Given By");
    $xls->Text($xlsRow,20,"Link");
    
    $xlsRow++;
    for($aw=0;$aw<$awards_count;$aw++)
    {
        $xls->Text($xlsRow,1,$awards_array[$aw]['first_name']);
        $xls->Text($xlsRow,2,$awards_array[$aw]['last_name']);
        $xls->Text($xlsRow,3,$awards_array[$aw]['title']);
        $xls->Text($xlsRow,4,$awards_array[$aw]['email']);
        $xls->Text($xlsRow,5,$awards_array[$aw]['phone']);
        $xls->Text($xlsRow,6,$awards_array[$aw]['company_name']);
        $xls->Text($xlsRow,7,$awards_array[$aw]['company_website']);
        $xls->Text($xlsRow,8,$awards_array[$aw]['company_revenue']);
        $xls->Text($xlsRow,9,$awards_array[$aw]['company_employee']);
        $xls->Text($xlsRow,10,$awards_array[$aw]['industry_title']);
        $xls->Text($xlsRow,11,$awards_array[$aw]['address']);
        $xls->Text($xlsRow,12,$awards_array[$aw]['address2']);
        $xls->Text($xlsRow,13,$awards_array[$aw]['city']);
        $xls->Text($xlsRow,14,$awards_array[$aw]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$awards_array[$aw]['zip_code']);
        
        $xls->Text($xlsRow,17,$awards_array[$aw]['awards_date']);
        $xls->Text($xlsRow,18,$awards_array[$aw]['awards_title']);
        $xls->Text($xlsRow,19,$awards_array[$aw]['awards_given_by']);
        $xls->Text($xlsRow,20,$awards_array[$aw]['awards_link']);
        $xlsRow++;
    }
}
...
if($publication_count > 0)
{
    ...
    $xls->Text($xlsRow,17,"Date");
    $xls->Text($xlsRow,18,"Title");
    $xls->Text($xlsRow,19,"Link");
    
    $xlsRow++;
    for($pu=0;$pu<=$publication_count;$pu++)
    {
        $xls->Text($xlsRow,1,$publication_array[$pu]['first_name']);
        $xls->Text($xlsRow,2,$publication_array[$pu]['last_name']);
        $xls->Text($xlsRow,3,$publication_array[$pu]['title']);
        $xls->Text($xlsRow,4,$publication_array[$pu]['email']);
        $xls->Text($xlsRow,5,$publication_array[$pu]['phone']);
        $xls->Text($xlsRow,6,$publication_array[$pu]['company_name']);
        $xls->Text($xlsRow,7,$publication_array[$pu]['company_website']);
        $xls->Text($xlsRow,8,$publication_array[$pu]['company_revenue']);
        $xls->Text($xlsRow,9,$publication_array[$pu]['company_employee']);
        $xls->Text($xlsRow,10,$publication_array[$pu]['industry_title']);
        $xls->Text($xlsRow,11,$publication_array[$pu]['address']);
        $xls->Text($xlsRow,12,$publication_array[$pu]['address2']);
        $xls->Text($xlsRow,13,$publication_array[$pu]['city']);
        $xls->Text($xlsRow,14,$publication_array[$pu]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$publication_array[$pu]['zip_code']);
        
        $xls->Text($xlsRow,17,$publication_array[$pu]['publication_date']);
        $xls->Text($xlsRow,18,$publication_array[$pu]['title']);
        $xls->Text($xlsRow,19,$publication_array[$pu]['link']);
...
if($media_count > 0)
{
    ...
    $xls->Text($xlsRow,17,"Date");
    $xls->Text($xlsRow,18,"Quote");
    $xls->Text($xlsRow,19,"Publication");
    $xls->Text($xlsRow,20,"Link");
    
    $xlsRow++;
    for($mm=0;$mm<=$media_count;$mm++)
    {
        $xls->Text($xlsRow,1,$media_array[$mm]['first_name']);
        $xls->Text($xlsRow,2,$media_array[$mm]['last_name']);
        $xls->Text($xlsRow,3,$media_array[$mm]['title']);
        $xls->Text($xlsRow,4,$media_array[$mm]['email']);
        $xls->Text($xlsRow,5,$media_array[$mm]['phone']);
        $xls->Text($xlsRow,6,$media_array[$mm]['company_name']);
        $xls->Text($xlsRow,7,$media_array[$mm]['company_website']);
        $xls->Text($xlsRow,8,$media_array[$mm]['company_revenue']);
        $xls->Text($xlsRow,9,$media_array[$mm]['company_employee']);
        $xls->Text($xlsRow,10,$media_array[$mm]['industry_title']);
        $xls->Text($xlsRow,11,$media_array[$mm]['address']);
        $xls->Text($xlsRow,12,$media_array[$mm]['address2']);
        $xls->Text($xlsRow,13,$media_array[$mm]['city']);
        $xls->Text($xlsRow,14,$media_array[$mm]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$media_array[$mm]['zip_code']);
        
        $xls->Text($xlsRow,17,$media_array[$mm]['pub_date']);
        $xls->Text($xlsRow,18,$media_array[$mm]['quote']);
        $xls->Text($xlsRow,19,$media_array[$mm]['publication']);
        $xls->Text($xlsRow,20,$media_array[$mm]['media_link']);
...
if($movement_count > 0)
{
    ...
    $xls->Text($xlsRow,17,"Announce Date");
    $xls->Text($xlsRow,18,"Effective Date");
    $xls->Text($xlsRow,19,"Source");
    $xls->Text($xlsRow,20,"Headline");
    $xls->Text($xlsRow,21,"Full Body");
    $xls->Text($xlsRow,22,"Short Url");
    $xls->Text($xlsRow,23,"Movement Type");
    $xls->Text($xlsRow,24,"What Happened");
    $xls->Text($xlsRow,25,"About Person");
    $xls->Text($xlsRow,26,"About Company");
    $xls->Text($xlsRow,27,"More Link");
    
    $xlsRow++;
    for($mo=0;$mo<=$movement_count;$mo++)
    {
        $xls->Text($xlsRow,1,$movement_array[$mo]['first_name']);
        $xls->Text($xlsRow,2,$movement_array[$mo]['last_name']);
        $xls->Text($xlsRow,3,$movement_array[$mo]['title']);
        $xls->Text($xlsRow,4,$movement_array[$mo]['email']);
        $xls->Text($xlsRow,5,$movement_array[$mo]['phone']);
        $xls->Text($xlsRow,6,$movement_array[$mo]['company_name']);
        $xls->Text($xlsRow,7,$movement_array[$mo]['company_website']);
        $xls->Text($xlsRow,8,$movement_array[$mo]['company_revenue']);
        $xls->Text($xlsRow,9,$movement_array[$mo]['company_employee']);
        $xls->Text($xlsRow,10,$movement_array[$mo]['industry_title']);
        $xls->Text($xlsRow,11,$movement_array[$mo]['address']);
        $xls->Text($xlsRow,12,$movement_array[$mo]['address2']);
        $xls->Text($xlsRow,13,$movement_array[$mo]['city']);
        $xls->Text($xlsRow,14,$movement_array[$mo]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$movement_array[$mo]['zip_code']);
        $xls->Text($xlsRow,17,$movement_array[$mo]['announce_date']);
        $xls->Text($xlsRow,18,$movement_array[$mo]['effective_date']);
        $xls->Text($xlsRow,19,$movement_array[$mo]['source']);
        $xls->Text($xlsRow,20,$movement_array[$mo]['headline']);
        $xls->Text($xlsRow,21,$movement_array[$mo]['full_body']);
        $xls->Text($xlsRow,22,$movement_array[$mo]['short_url']);
        $xls->Text($xlsRow,23,$movement_type);
        $xls->Text($xlsRow,24,$movement_array[$mo]['what_happened']);
        $xls->Text($xlsRow,25,$movement_array[$mo]['about_person']);
        $xls->Text($xlsRow,26,$movement_array[$mo]['about_company']);
        $xls->Text($xlsRow,27,$movement_array[$mo]['more_link']);
...
if($funding_count > 0)
{
    ...
    $xls->Text($xlsRow,17,"Funding Amount");
    $xls->Text($xlsRow,18,"Funding Date");
    $xls->Text($xlsRow,19,"Funding Source");
    
    $xlsRow++;
    for($fu=0;$fu<=$funding_count;$fu++)
    {
        $xls->Text($xlsRow,1,$funding_array[$fu]['first_name']);
        $xls->Text($xlsRow,2,$funding_array[$fu]['last_name']);
        $xls->Text($xlsRow,3,$funding_array[$fu]['title']);
        $xls->Text($xlsRow,4,$funding_array[$fu]['email']);
        $xls->Text($xlsRow,5,$funding_array[$fu]['phone']);
        $xls->Text($xlsRow,6,$funding_array[$fu]['company_name']);
        $xls->Text($xlsRow,7,$funding_array[$fu]['company_website']);
        $xls->Text($xlsRow,8,$funding_array[$fu]['company_revenue']);
        $xls->Text($xlsRow,9,$funding_array[$fu]['company_employee']);
        $xls->Text($xlsRow,10,$funding_array[$fu]['industry_title']);
        $xls->Text($xlsRow,11,$funding_array[$fu]['address']);
        $xls->Text($xlsRow,12,$funding_array[$fu]['address2']);
        $xls->Text($xlsRow,13,$funding_array[$fu]['city']);
        $xls->Text($xlsRow,14,$funding_array[$fu]['state_short']);
        $xls->Text($xlsRow,15,$country);
        $xls->Text($xlsRow,16,$funding_array[$fu]['zip_code']);
        
        $xls->Text($xlsRow,17,$funding_array[$fu]['funding_amount']);
        $xls->Text($xlsRow,18,$funding_array[$fu]['funding_date']);
        $xls->Text($xlsRow,19,$funding_array[$fu]['funding_source']);
...
if($jobs_count > 0)
{
    ...
    $xls->Text($xlsRow,1,"Company Name");
    $xls->Text($xlsRow,2,"Phone");
    
    $xls->Text($xlsRow,3,"Company Website");
    $xls->Text($xlsRow,4,"Company Size Revenue");
    $xls->Text($xlsRow,5,"Company Size Employees");
    $xls->Text($xlsRow,6,"Company Industry");
    $xls->Text($xlsRow,7,"Address");
    $xls->Text($xlsRow,8,"Address 2");
    $xls->Text($xlsRow,9,"City");
    $xls->Text($xlsRow,10,"State");
    $xls->Text($xlsRow,11,"Country");
    $xls->Text($xlsRow,12,"Zip Code");
    
    $xls->Text($xlsRow,13,"Job Title");
    $xls->Text($xlsRow,14,"Job Location");
    $xls->Text($xlsRow,15,"Job Post Date");
    $xls->Text($xlsRow,16,"Job Source");
    ...
    for($jo=0;$jo<=$jobs_count;$jo++)
    {
        ...
        $xls->Text($xlsRow,1,$jobs_array[$jo]['company_name']);
        //$xls->Text($xlsRow,3,$jobs_array[$jo]['title']);
        //$xls->Text($xlsRow,4,$jobs_array[$jo]['email']);
        $xls->Text($xlsRow,2,$jobs_array[$jo]['phone']);
        
        $xls->Text($xlsRow,3,$jobs_array[$jo]['company_website']);
        $xls->Text($xlsRow,4,$jobs_array[$jo]['company_revenue']);
        $xls->Text($xlsRow,5,$jobs_array[$jo]['company_employee']);
        $xls->Text($xlsRow,6,$jobs_array[$jo]['industry_title']);
        $xls->Text($xlsRow,7,$jobs_array[$jo]['address']);
        $xls->Text($xlsRow,8,$jobs_array[$jo]['address2']);
        $xls->Text($xlsRow,9,$jobs_array[$jo]['city']);
        $xls->Text($xlsRow,10,$jobs_array[$jo]['state_short']);
        $xls->Text($xlsRow,11,$country);
        $xls->Text($xlsRow,12,$jobs_array[$jo]['zip_code']);
        
        $xls->Text($xlsRow,13,$jobs_array[$jo]['job_title']);
        $xls->Text($xlsRow,14,$jobs_array[$jo]['location']);
        $xls->Text($xlsRow,15,$jobs_array[$jo]['post_date']);
        $xls->Text($xlsRow,16,$jobs_array[$jo]['source']);
