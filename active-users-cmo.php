...
$mail->Subject       = "CMO Active Users activity details";
...
$q = "select * from exec_user $where_clause where (site = 'cmo') and status = 1 order by user_id desc";
echo "<br>Q: ".$q;
...
if($user_rows > 0)
{    
    $msg = "Below is CMO active user activity details on Execfile:<br><br>";
