...
$mail->Subject       = "Active Users activity details";
...
$q = "select * from exec_user $where_clause where (site = '' or site = 'hr') and status = 1 order by user_id desc";
echo "<br>Q: ".$q;
...
if($user_rows > 0)
{    
    $msg = "Below is HR active user activity details on Execfile:<br><br>";
