                    ...
                    <div class="form-bottom clearfix">
                            <div class="fcol fcol2 h220" style="height:248px;">
                                    ...
                                    <div class="row row-checkboxes">
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="speaking" id="speaking" <?PHP if($speaking==1){echo 'checked="checked"';}else{echo '';}?> /><label style="text-align:left;margin-left:5px;width:80%;" for="speaking">Speaking Engagements</label></div><!-- /.checkbox -->
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="awards" id="awards" <?PHP if($awards==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="awards">Industry Awards</label></div><!-- /.checkbox -->
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="publication" id="publication" <?PHP if($publication==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="publication">Publications</label></div><!-- /.checkbox -->
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="media_mentions" id="media_mentions" <?PHP if($media_mentions==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="media_mentions">Media Mentions</label></div><!-- /.checkbox -->
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="board" id="board" <?PHP if($board==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="board">Board Appointments</label></div><!-- /.checkbox -->

                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="jobs" id="jobs" <?PHP if($jobs==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="jobs">Jobs</label></div> <!-- /.checkbox -->
                                            <div class="checkbox-holder clearfix"><input type="checkbox" value="1" class="checkbox" name="fundings" id="fundings" <?PHP if($fundings==1){echo 'checked="checked"';}else{echo '';}?>/><label style="text-align:left;margin-left:5px;" for="fundings">Fundings</label></div>  <!-- /.checkbox -->
                                    </div><!-- /.row -->
                            </div><!-- /.fcol fcol2 -->
