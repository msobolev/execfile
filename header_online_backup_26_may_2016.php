...
function zipKeyPress(e)
{
    ...
    if (e.keyCode == 13)
    {
        ...
        {    
            ...
            window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&zip="+zip_val+"&industries="+hidden_industries+"&revenue="+hidden_revenue+"&states="+hidden_states+"&city="+city_val+"&employee_size="+hidden_employee_size;
        }    
    }    
}
...
function searchKeyPress(e)
{
    ...
    if (e.keyCode == 13)
    {
        ...
        {    
            ...
            window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&searchnow="+searchnow+"&industries="+hidden_industires+"&revenue="+hidden_revenue+"&states="+hidden_states+"&city="+city_val+"&employee_size="+hidden_employee_size;
        }    
    }    
}
    ...
    { 
        ...
        {    
            ...
            else
            {
                ...
                window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&zip="+zip_val+"&companyval="+searchnow+"&states="+hidden_states+"&industries="+industries+"&city="+city_val+"&revenue="+hidden_revenue+"&employee_size="+hidden_employee_size;
            }    
        }    
    }    
}
...
{ 
    ...
    if (e.keyCode == 13)
    {
        ...
        {    
            ...
            window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&zip="+zip_val+"&city="+city_val+"&states="+hidden_states+"&industries="+industries+"&revenue="+hidden_revenue+"&employee_size="+hidden_employee_size;
        }    
    }    
}
...
{ 
    ...
    window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&zip="+zip_val+"&city="+city_val+"&industries="+industries+"&states="+hidden_states+"&revenue="+hidden_revenue+"&employee_size="+hidden_employee_size;
}
...
function update_state_search()
{
    ...
    window.location.href = "http://www.execfile.com/home.php?from_date="+from_date+"&to_date="+to_date+"&type="+type+"&zip="+zip_val+"&city="+city_val+"&industries="+industries+"&states="+states+"&revenue="+hidden_revenue+"&employee_size="+hidden_employee_size;
    ...
    <header class="header">
        ...
        <a href="home.php?funtion=hr" class="logo-mobile hidden-ds">Execfile</a>
            <div class="header-inner">
                ...
                ?>
                <li <?=$feed_class?> style="color:white;"><a href="home.php?from_date=&to_date=&type=all&zip=&companyval=<?=$_GET['company']?>&states=&industries=&city=&revenue=&employee_size=">Feed</a></li>
                <li <?=$org_chart_class?> style="color:white;"><a href="home.php?funtion=hr&org=1&company=<?=$_GET['companyval']?>">Org Chart</a></li>
                <?PHP
                }
                ?>
                </nav>
