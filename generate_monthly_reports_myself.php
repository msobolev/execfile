...
$from = 'faraz.aia@nxvt.com';//'msobolev@execfile.com';
...
{    
    foreach($sites as $site)
    {
        ...
        $firstDateOfReport = $_GET['starting'];
        $LastDateOfReport = $_GET['ending'];
        ...
        $fileName = $site."-".$firstDateOfReport."_".$LastDateOfReport.".xls";
