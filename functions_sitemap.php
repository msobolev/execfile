...
function get_all_data($id='',$type='',$limit = '',$func = '',$from_date = '',$to_date='',$zip='',$searchnow = '',$city = '',$company = '',$industries_ids = '',$state_ids ='',$revenue = '',$employee_size = '',$display_type = '')
{
    ...
    {    
        ...
        if($limit != '')
        {
            ...
            $default_speaking_limit = " limit ".$limit;
        }    
        $from_date_clause = "";
        $to_date_clause = "";
...
?>
    ...
    <li class="article">
        ...
        <div class="article-content" style="<?=$width?>">
            <p><?=$first_name?> <?=$last_name?> was <?=$movement_text?> as <?=$title?> at <?=$company_name?>.</p>
