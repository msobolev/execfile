<style>
    /*
.treeview ul, treeview.li { list-style: none; margin: 0; padding: 0; }
...
.treeview ul .treeview li:last-child treeview ul {
        ...
        <div class="content" style="padding-left:323px;margin-bottom:100px;">
            ...
            <div style="display:block;float:left;width:100%">
                ...
                { 
                    ...
                    echo "<li  class=container><p>";
                    
                    $next_index = next($chart_arr); 
                    //echo "<pre>next index: ";   print_r($next_index);   echo "</pre>";
                    
                ?>
                    <img src="no-personal-image.png" height="80" width="80" alt="" class="article-avatar">
                    <?=$next_index['level']?>::<?=$chart_data['first_name']?> <?=$chart_data['last_name']?>  <?=$chart_data['title']?> at <?=$chart_data['company_name']?>  
                        </p>
                <?PHP
                }
                ?>
                ...
                ?>
                    ...
                    <div style="float:left;width:100%;">
                        ...
                        <div style="float:left;width:75%;margin-top:-35px;">
                            <img src="no-personal-image.png" height="80" width="80" alt="" class="article-avatar">
                            <?=$next_index['level']?>::<?=$chart_data['first_name']?> <?=$chart_data['last_name']?> at <?=$chart_data['title']?>  <?=$chart_data['company_name']?>
                ...
                ?>
                    <div style="float:left;width:100%;">
                        <div style="width:10%;float:left;margin-left:158px;border:1px solid;" class="horizontal-line">
                            
                        </div>
                        <div style="float:left;width:65%;margin-top:-78px;">
                ...
                <div style="display:block;float:left;width:100%;margin-left:159px;">
                    <div style="display:block;float:left;width:10%;height:81px;">
                        <div style="display:block;float:left;width:1px;height:40px;border:1px dashed #808080;">
                        </div>

                        <div style="display:block;float:left;width:100%;height:1px;border:1px dashed #808080;">   
                        </div>
            ...
            <div style="display:block;float:left;width:100%;margin-left:160px;">
                <div style="display:block;float:left;width:10%;height:81px;">
                    <div style="display:block;float:left;width:100%;height:40px;border-left:1px dashed #808080;">
                    </div>

                    <div style="display:block;float:left;width:100%;height:1px;border-top:1px dashed #808080;">   
                    </div>
            ...
            http://codepen.io/jaminroe/pen/EJvcw
            ...
            <section class="section-primary">
                ...
                <div class="section-body">
                    ...
                    { 
                        ...
                        {
                            show_media($all_data[$i]['first_name'],$all_data[$i]['last_name'],$all_data[$i]['id'],$all_data[$i]['personal_id'],$all_data[$i]['company_name'],$all_data[$i]['title'],$all_data[$i]['email'],$all_data[$i]['phone'],$all_data[$i]['personal_image'],$all_data[$i]['publication'],$all_data[$i]['media_link'],$all_data[$i]['media_link'],$all_data[$i]['pub_date'],$personal_pic_root,$all_data[$i]['show_state']);
                        }
                    }
