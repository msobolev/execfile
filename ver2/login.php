...
<div class="round-box">
    <form name="frm_login" method="post" action="res-process.php?action=UserLogin">
        <div class="inner-field-box">
            ...
            <input class="loginbox" name="login_email" id="login_email" type="text" value="<?=$login_email?>" onfocus="ClassChangeFocus('loginbox_email');" onkeyup="ShowSignUpButton();" onblur="ClassChangeBlur('loginbox_email');"/>
            </div>
            </div> 
            ...
            <div class="field1">
                <div id="loginbox_password" <?PHP if($action=='LoginPassword' || $action=='LoginEmailPassword'){echo 'class="loginboxdiv_error"';}else{ echo 'class="loginboxdiv"';} ?>>
                    <input class="loginbox" name="login_pass" id="login_pass" type="password" onfocus="ClassChangeFocus('loginbox_password');" onkeyup="ShowSignUpButton();" onblur="ClassChangeBlur('loginbox_password');" />
                </div>
            </div>
