                    ...
                    <div class="form-content clearfix">
                            <div class="fcol fcol2 h490">
                                ...
                                <div class="form-content">
                                    <div class="fields">
                                        <div class="row"><label>Title:</label><input style="height:35px;width:260px;margin-left:4px;" type="text" name="title" id="title" title="e.g. HR and Human Capital Executives" value="<?PHP if($title==''){echo 'e.g. HR and Human Capital Executives';}else{echo $title;}?>" class="field" /></div><!-- /.row -->
                                ...
                                <div class="fields">
                                    ...
                                    <div style="display:block; float:left;width:100%;">
                                        ...
                                        <span class="row select140">
                                            <label style="width:162px;vertical-align:top;">State</label>
                                        </span>
                                    ...
                                    <span style="margin-left:165px;">
                                        ...
                                        <input style="margin-left:0px;width: 260px;height: 35px;margin-top: 6px;" name="zip_code" type="text" id="zip_code" title="Zip Code" value="<?PHP if($zip_code==''){echo 'Zip Code';}else{echo $zip_code;}?>" class="field" />
                                    </span><!-- /.row -->    

                                    <div class="row"><label>City</label><input style="margin-left:4px;width:260px;height:35px;" name="city" type="text" id="city" title="" value="<?=$city?>" class="field" /></div><!-- /.row -->
                                </div><!-- /.fields -->
                            </div><!-- /.fcol fcol2 -->	
                            ...
                            <div class="fcol fcol2 h490" style="height:553px;">
                                ...
                                <div class="fields">
                                        ...
                                        <div class="row row-textarea" style="display:block; float:left;"><label class="posr-label-textarea" style="padding-right:10px;display:block; float:left;width:160px;padding-top:85px;">Paste URLs (up to 25)<br />of companies you'd <br />like to track</label>
                                                <textarea name="company_website" id="company_website" class="field-textarea"><?=$company_website?></textarea>
                                        </div><!-- /.row -->
                                        <div class="row" style="padding-top:0px;"><label style="width:125px;vertical-align:top;">Industry</label>
                                        ...
                                        <div class="row"><label style="vertical-align:top;width:128px;">Size ($ Revenue)</label>
                                        ...
                                        <div class="row"><label style="vertical-align:top;width:128px;">Size (Employees)</label>
