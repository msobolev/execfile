	...
	if(isset($_POST['email_address']) && isset($_POST['password'])) 
        {
           ...
           // echo "<pre>check_admin_query: ";   print_r($check_admin);    echo "</pre>";    
            //die();
            $row_count = com_db_num_rows($check_admin_query);
            
            //if($email_address == 'admin' && $password == 'passw')
            if($row_count > 0)
            {    
                //if($check_admin_query){
                ...
                */    
                    ...
                    $_SESSION['login_first_name']='Admin';
...
<title>HREXECsonthemove.com :: Admin Control Panel</title>
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
				...
				<div id="LiginDiv" style="display:<? if($action=='ForgotPassword'){echo 'none';}else{echo 'block';}?>;">
				...
				<!-- <div id="ForgotPasswordDiv" style="display:<? if($action=='ForgotPassword'){echo 'block';}else{echo 'none';}?>;"> -->
