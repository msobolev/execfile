...
function update_user_counts($unread_movements_count,$unread_speaking_count,$unread_media_count,$unread_award_count,$unread_publication_count,$unread_funding_count,$unread_job_count)
{
    ...
    {    
        ...
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_movements_count.",'movement',".$this_user.")");	
        
        com_db_query("DELETE FROM ".TABLE_COUNT." where record_type='speaking' and user_id = ".$this_user);	
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_speaking_count.",'speaking',".$this_user.")");	
        ...
        com_db_query("DELETE FROM ".TABLE_COUNT." where record_type='awards' and user_id = ".$this_user);	
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_award_count.",'awards',".$this_user.")");	
        
        
        com_db_query("DELETE FROM ".TABLE_COUNT." where record_type='publication' and user_id = ".$this_user);	
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_publication_count.",'publication',".$this_user.")");	
        
        
        com_db_query("DELETE FROM ".TABLE_COUNT." where record_type='funding' and user_id = ".$this_user);	
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_funding_count.",'funding',".$this_user.")");	
        
        
        com_db_query("DELETE FROM ".TABLE_COUNT." where record_type='jobs' and user_id = ".$this_user);	
        com_db_query("INSERT INTO ".TABLE_COUNT."(user_count,record_type,user_id) values(".$unread_job_count.",'jobs',".$this_user.")");	
...
function get_all_data($id='',$type='',$func = '',$from_date = '',$to_date='',$zip='',$searchnow = '',$city = '',$company = '',$industries_ids = '',$state_ids ='',$revenue = '',$employee_size = '',$display_type = '')
{
    ...
    //echo "<br>media_last_id_db: ".$media_last_id_db;
    ...
    {    
        ...
        $indResult = mysql_query("select mm.move_id,pm.personal_id,ps.speaking_link,first_name,last_name,
            ...
            group by ps.speaking_id order by speaking_id desc",$site);
        ...
        echo "<br>SPEAKING QUERY: select mm.move_id,pm.personal_id,ps.speaking_link,first_name,last_name,
            ...
            $revenue_clause $zip_clause $city_clause $company_personal_clause
            $industries_clause $state_clause $employee_size_clause    
            group by ps.speaking_id order by speaking_id desc";
        */
    ...
    if($type == 'media' || $type == 'media_mention' || $type == 'all')
    {
        ...
        $indResult = mysql_query("select pm.personal_id,pmm.media_link,first_name,last_name,
            ...
            GROUP BY mm_id order by mm_id desc",$site);
        
        /*
        echo "select pm.personal_id,pmm.media_link,first_name,last_name,
            personal_image,pm.email as email,mm_id,pmm.publication,pmm.pub_date,
            pmm.add_date as add_date,cm.company_name,mm.title,pm.phone,
            cm.company_revenue,cm.company_employee,cm.address,cm.address2,cm.city,cm.zip_code,
            cm.company_website,pmm.quote,ci.title as industry_title,cs.short_name as state_short
    ...
    if($type == 'publication' || $type == 'all')
    {
        ...
        $indResult = mysql_query("select pm.personal_id,ppp.link,first_name,last_name,personal_image,
            ...
            group by personal_id order by publication_id desc",$site);
    ...
    if($type == 'funding' || $type == 'all')
    {
        ...
        $indResult = mysql_query("SELECT pm.personal_id,cf.funding_source,mm.move_id,pm.first_name, pm.last_name,
            ...
            $revenue_clause)  order by funding_id desc",$site);
