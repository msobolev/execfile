        ...
        <div class="content" style="padding-left:323px;">
            <section class="section-primary">
                ...
                <div class="section-body">
                    ...
                    $last_media_id = $first_media_arr[0];
                    $last_publication_id = $first_publication_arr[0];
...
else
{
    ...
    $unread_movements_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'movement'");
    
    //echo "<br>In else";
    
    $unread_speaking_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'speaking'");
    
    $unread_media_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'media'");
    
    $unread_award_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'awards'");
    
    $unread_publication_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'publication'");
    
    $unread_funding_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'funding'");
    
    $unread_job_count = com_db_GetValue("select user_count from ".TABLE_COUNT." where user_id='".$_SESSION['sess_user_id']."' and record_type = 'jobs'");
