...
<div style="margin:0px auto;width:990px;">    
    ...
    {    
    ?>
    <div class="intro-content" style="width:490px;margin: 0 auto;">
    <!-- <h3 style="text-align:left;width:100%;padding:0px 0px 15px 0px;margin:0px;">Request A Demo</h3> -->
    <h1 style="width:600px;margin-bottom: 15px;font-size:53px;">Forgot Your Password?</h1>

    <div class="form-sing-up">
        {{-- <form action="{{ url('forgotpassword')  }}" method="post" onsubmit="return filter_email('email_rq');"> --}}
            ...
            <div class="form-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-controls">
                        <i class="ico-mail"></i>
                        <input style="border:1px solid #CCCCCC;" type="email" class="field" name="email_rq" id="email_rq" value="" placeholder="Type in your email address, associated with your profile">
                    </div><!-- /.form-controls -->
                </div><!-- /.form-row -->
