...
//{
    ...
    */
    ...
    while($indRow = mysql_fetch_array($main_res))
    {
        ...
        $headline = mysql_real_escape_string($indRow['headline']);
        $full_body = mysql_real_escape_string($indRow['full_body']);
